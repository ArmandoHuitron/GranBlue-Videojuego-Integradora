...
define config.name = _("Misterio Sobre Ruedas")
...
define build.name = "MisterioSobreRuedas"


define config.developer = "Grand Blue"
## Sonidos y música ############################################################
...
define config.save_directory = "MisterioSobreRuedas-1759160500"
